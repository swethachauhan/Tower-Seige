...
function setup(){
    ...
    box1=new Box(450,100,30,40);
    box2=new Box(450,140,30,40);
    box3=new Box(450,180,30,40);
    box4=new Box(450,200,30,40);
    box5=new Box(480,140,30,40);
    box6=new Box(480,180,30,40);
    box7=new Box(480,200,30,40);
    box8=new Box(420,140,30,40);
    box9=new Box(420,180,30,40);
    box10=new Box(420,200,30,40);
    box11=new Box(390,180,30,40);
    box12=new Box(390,200,30,40);
    box13=new Box(510,180,30,40);
    box14=new Box(510,200,30,40);
    box15=new Box(540,200,30,40);
    box16=new Box(360,200,30,40);
   ...
   // box28=new Box(770,140,30,40);
    ...
    box212=new Box(740,200,30,40);
    //box213=new Box(860,180,30,40);
    box214=new Box(860,200,30,40);
